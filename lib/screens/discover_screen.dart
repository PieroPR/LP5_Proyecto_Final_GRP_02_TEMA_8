          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  customCard("Musica", MdiIcons.music),
                  customCard("Juegos", MdiIcons.gamepadSquareOutline),
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  customCard("E-sports", MdiIcons.medalOutline),
            ...
            Padding(
              ...
              child: customText("CANALES EN VIVO QUE CREEMOS QUE TE GUSTARÁN"),
            ),
            SizedBox(
              height: 350,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  customText("NOSOTROS PENSAMOS QUE TE GUSTARÁ"),
                ],
              ),
            ),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15.0),
              child: customText("COMUNIDADES PEQUEÑAS RECOMENDADAS"),
            ),
            SizedBox(
              height: 350,
              child: ListView.builder(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15.0),
              child: customText("¡TODOS A BORDO DEL TREN HYPE!"),
            ),
            SizedBox(
              height: 350,
              child: ListView.builder(
