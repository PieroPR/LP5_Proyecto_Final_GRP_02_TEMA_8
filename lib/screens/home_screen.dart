          ...
          slivers: [
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(
                child: customText("Siguiendo", 35),
              ),
            ),
            SliverPadding(
              padding: const EdgeInsets.symmetric(vertical: 5.0),
              sliver: SliverToBoxAdapter(
                child: customText("Categorias seguidas", 25),
              ),
            ),
            getCategoriSection(),
            SliverPadding(
              padding: const EdgeInsets.symmetric(vertical: 15.0),
              sliver: SliverToBoxAdapter(
                child: customText("Tus canales en vivo", 25),
              ),
            ),
            streamersList(),
            SliverPadding(
              padding: const EdgeInsets.symmetric(vertical: 15.0),
              sliver: SliverToBoxAdapter(
                child: customText("Canales recomendados para ti", 25),
              ),
            ),
            streamersList(),
          ],
